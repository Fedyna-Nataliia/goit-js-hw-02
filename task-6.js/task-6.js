...
//нужно отфильтровать юзеров по возрасту, старше минимального и младше максимального, потом вернуть объектом имя и емейл каждого из отфильтрованных (edited) 
